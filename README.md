...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-01-04 13:51`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/9630b2f0-fdcd-4380-9555-d0f1881f573b.git
$ cd 9630b2f0-fdcd-4380-9555-d0f1881f573b
```
